...
class TestPawn(unittest.TestCase):
    ...
    def setUp(self):
        self.all_pawn_positions = {'w':[[5, 1], [5, 3], [5, 5], [5, 7],
                                        [6, 0], [6, 2], [6, 4], [6, 6],
                                        [7, 1], [7, 3], [7, 5], [7, 7]],
                                   'b':[[0, 0], [0, 2], [0, 4], [0, 6],
                                        [1, 1], [1, 3], [1, 5], [1, 7],
    ...
    def test_return_possible_regular_movements_22(self):
        pawn = Pawn('b', [2, 2])
        pawn.return_possible_regular_movements(self.all_pawn_positions)
        self.assertEqual(pawn.possible_movement,[[3, 3], [3, 1]])

    def test_return_possible_regular_movements_23(self):
        pawn = Pawn('b', [2, 4])
        pawn.return_possible_regular_movements(self.all_pawn_positions)
        self.assertEqual(pawn.possible_movement,[[3, 5], [3, 3]])

    def test_return_possible_regular_movements_24(self):
        pawn = Pawn('b', [2, 6])
        pawn.return_possible_regular_movements(self.all_pawn_positions)
        self.assertEqual(pawn.possible_movement,[[3, 7], [3, 5]])
